...
function setup() {
    ...
    b2.position(width / 2, height / 9);
    b2.size(50, 50);
    b2.mouseClicked(soltar2);

    b3 = createImg("cut_btn.png");
    b3.position(width / 1.5, height / 5);
    b3.size(50, 50);
    ...
    corda2 = new Rope(7, { x: width / 2, y: height / 9 });

    corda3 = new Rope(7, { x: width / 1.5, y: height / 5 });
